...
public sealed class RecentFilesUITests : UITestBase
{
    ...
    public void OpenFileTwice_OnlyOpensOnce()
    {
        ...
        var titleAfterFirst = MainWindow!.Title;
        ...
        var titleAfterSecond = MainWindow.Title;
    ...
    public void SwitchingTabs_UpdatesRecentFilesOrder()
    {
        ...
        Assert.IsTrue(MainWindow!.Title.Contains("order2.txt"), 
            $"order2.txt should be selected, but title was '{MainWindow.Title}'");
        ...
        Assert.IsTrue(MainWindow.Title.Contains("order1.txt"), 
            $"order1.txt should be selected after switch, but title was '{MainWindow.Title}'");
